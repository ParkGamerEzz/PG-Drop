<div align="center">
  <a href="https://github.com/schlagmichdoch/PGDrop">
    <img src="public/images/android-chrome-512x512.png" alt="Logo"  width="150" height="150">
  </a>
 
  # _Send it_, with [PGDrop](https://PGDrop.net)

  <p>
    Local file sharing <a href="https://PGDrop.net"><strong>in your web browser</strong></a>. 
    <br />
    <br />
    <a href="https://github.com/schlagmichdoch/PGDrop/issues">Report a bug</a>
    <br />
    <a href="https://github.com/schlagmichdoch/PGDrop/issues">Request feature</a>
  </p>
</div>
...
<img src="docs/PGDrop_screenshot_mobile.gif" alt="Screenshot GIF showing PGDrop in use" style="width: 300px">
...
* Devices outside of your local network that are behind a NAT are auto-connected via the PGDrop TURN server.
* Connect to devices on your mobile hotspot.
...
* Pairing is persistent. You find your devices even after reopening PGDrop.
...
* Public rooms are temporary. Closing PGDrop  leaves all rooms.
...
* Warn user before PGDrop is closed on file transfer
* Open PGDrop on multiple tabs simultaneously (Thanks [@willstott101](https://github.com/willstott101))
...
* To host PGDrop on your local network (e.g. on Raspberry Pi): [All peers connected with private IPs are discoverable by each other](https://github.com/RobinLinus/snapdrop/pull/558)
* When hosting PGDrop yourself, you can [set your own STUN/TURN servers](docs/host-your-own.md#specify-stunturn-servers)
* Translations.

</details>

## Translate PGDrop on [Hosted Weblate](https://hosted.weblate.org/engage/PGDrop/)
<a href="https://hosted.weblate.org/engage/PGDrop/">
<img src="https://hosted.weblate.org/widget/PGDrop/horizontal-blue.svg" alt="Translation status" style="width: 300px" />
</a>
...
## Support
<a href="https://www.buymeacoffee.com/PGDrop" target="_blank">
<img src="https://cdn.buymeacoffee.com/buttons/v2/default-blue.png" alt="Buy me a coffee" style="height: 60px !important;width: 217px !important;" >
</a>
<br />
<br />

PGDrop is libre, and always will be. \
...
## Contributing
Feel free to [open an issue](https://github.com/schlagmichdoch/PGDrop/issues/new/choose) or a
[pull request](https://github.com/schlagmichdoch/PGDrop/pulls), following the
