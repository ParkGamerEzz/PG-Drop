class Localization {
    constructor() {
        ...
        Localization.supportedLocales = ["ar", "ca", "de", "en", "es", "fr", "id", "it", "ja", "kn", "nb", "nl", "pt-BR", "ro", "ru", "tr", "zh-CN", "th"];
    ...
    static logHelpCall() {
        console.log("Help translating PGDrop: https://hosted.weblate.org/engage/PGDrop/");
    }
    ...
    static logHelpCallKey(key, attr) {
        ...
        console.warn(`Translate this string here: https://hosted.weblate.org/browse/PGDrop/PGDrop-spa/${locale}/?q=${keyComplete}`);
    }
